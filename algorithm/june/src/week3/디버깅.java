...
//                useMap[yx[0]][yx[1]]=0;
                monster+=1;
//                if (archer.get(0) == 1 && archer.get(1) == 2 && archer.get(2) == 4) {
//                	System.out.println(yx[0] + " , " + yx[1] + " : " + useMap[yx[0]][yx[1]]);
//                	// System.out.println(monster);
//                }
            	test.add(new node(yx[0], yx[1]));
            }
        }
        ...
        for(int i=0;i<test.size();i++) {
        	if (archer.get(0) == 1 && archer.get(1) == 2 && archer.get(2) == 4) {
        	 ...
        	 useMap[test.get(i).x ][test.get(i).y]=0;
        }
